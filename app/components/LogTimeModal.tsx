...
export default function LogTimeModal({ isOpen, onClose, onOptimisticAdd, onSuccess }: LogTimeModalProps) {
  ...
  // Right before rendering (for debug; Log Time is the reference "working" one)
  console.log('[LogTimeModal] right before rendering the Case select, cases array being used:', cases);
